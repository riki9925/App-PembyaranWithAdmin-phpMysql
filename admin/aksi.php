...
<div id="content">
	...
	$query="SELECT *FROM stor where id_kelas='$kelas'";
	...
	{	
		...
		//print("Semester :<br />");
		$q_sems="SELECT id_bayar,id_kelas,semester FROM stor WHERE id_kelas='$kelas'GROUP BY semester";
		$hasil=mysql_query($q_sems,$koneksi);
		while($data=mysql_fetch_array($hasil))
		{
			print("<a href=\"aksikelas.php?idkelas=$data[id_kelas]_$data[semester]\">Semester :$data[semester]</a>");
			print("<br/>");	
		}	
	}
	else
